export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Responsive dashboard interface with reusable components, data visualization, and optimized layout for performance and usability.",
    image:
      "https://images.unsplash.com/photo-1551281044-8d8c5b7b2a5d?auto=format&fit=crop&w=1200&q=80",
    liveUrl: "#",
    githubUrl: "#",
    featured: false,
  },
  ...
  },
  {
    ...
    category: "ui-experiment",
    stack: ["React", "DaisyUI", "Tailwind CSS"],
    description:
      "Reusable UI components system including cards, buttons, and layout sections to improve development speed and consistency.",
    image:
